...
REM ****************
REM usage: build_shaders <shaderProjectName>
REM ****************
...
:usage
echo.
echo "usage: build_shaders <shaderProjectName> [-game] [gameDir if -game was specified] [-source sourceDir]"
...
echo "ex   : build_shaders myshaders"
echo "ex   : build_shaders myshaders -game c:\steam\steamapps\sourcemods\mymod -source c:\mymod\src"
goto :end
