...
call buildshaders.bat stdshader_dx9_20b		-game %GAMEDIR% -source %SOURCEDIR%
call buildshaders.bat stdshader_dx9_30      -game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30 
