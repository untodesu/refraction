...
BEGIN_VS_SHADER( RE_LightmappedGeneric, "Help for RE_LightmappedGeneric" )
    BEGIN_SHADER_PARAMS
...
END_SHADER_PARAMS
    ...
    SHADER_FALLBACK
    {
        ...
        return 0; // to see if it even works...
    }
    ...
    SHADER_DRAW
    {
        DrawLightmappedGeneric( this, params, pShaderAPI, pShaderShadow, s_info, pContextDataPtr );
    }
END_SHADER
