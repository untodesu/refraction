...
public:
    ...
    struct DrawFlashlight_Vars_t
    {
        DrawFlashlight_Vars_t()
        {
            // set all ints to -1
    ...
    void DrawFlashlight( IMaterialVar** params, IShaderDynamicAPI *pShaderAPI, IShaderShadow* pShaderShadow, DrawFlashlight_Vars_t &vars );
